                ...
                <Flex css={{
                    ...
                    >
                        ...
                        <Flex direction={"column"}
                            ...
                            <FeatureButton text="High-Performance C++" link="#highPerformance"
                                           gradient="45deg, $blue600 -20%, $pink600 75%"/>
                            <FeatureButton text="Intuitive, Modern API" link="#modernAPI"
                                           gradient="120deg, $red600 -20%, $yellow600 80%"/>
                            <FeatureButton text="Cross-Platform" link="#crossPlatform"
                                           gradient="45deg, $green600 -20%, $blue600 100%"/>
                            <FeatureButton text="Open-Source" link="#openSource"
                                           gradient="120deg, $pink600 -20%, $red600 100%"/>
                        </Flex>
                    </Flex>
                </Flex>
